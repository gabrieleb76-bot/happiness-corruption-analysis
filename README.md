...
A través de un pipeline completo de análisis de datos —que incluye limpieza de datos, modelado en SQL, consultas analíticas y análisis exploratorio (EDA) en Python— identificamos patrones globales y regionales en los niveles de bienestar.
...
(Inserten aquí el scatter plot generado en el notebook)
...
Diseñamos una base de datos con tres tablas:
...
Utilizamos consultas analíticas con:
...
Aunque la corrupción influye en el bienestar, no es el único factor explicativo. Las variables económicas y sociales desempeñan un papel clave.
...
Qué hicimos
Analizamos la relación entre corrupción percibida y felicidad a nivel global.
